...
import com.xolo.gzqc.ui.activity.boss.BuymDetailActivity;
import com.xolo.gzqc.ui.activity.boss.DealAppointmentDetailedActivity;
import com.xolo.gzqc.ui.activity.boss.FinishDetailActivity;
import com.xolo.gzqc.ui.activity.boss.OfferDetailActivity;
import com.xolo.gzqc.ui.activity.boss.OutcarDetailActivity;
import com.xolo.gzqc.ui.activity.boss.PickUpCarDetailActivity;
import com.xolo.gzqc.ui.activity.boss.PurchaseReservationDetailedActivity;
import com.xolo.gzqc.ui.activity.boss.ReceiptsDetailActivity;
import com.xolo.gzqc.ui.activity.boss.RepairdetailActivity;
import com.xolo.gzqc.ui.activity.boss.SearchDataAnalysisActivity;
import com.xolo.gzqc.ui.activity.boss.SettledDetailActivity;
import com.xolo.gzqc.ui.activity.boss.UnsettledDetailActivity;
...
import static com.xolo.gzqc.R.id.tab;
...
public class BossMainFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_data_analysis, container, false);
    ...
    private void initData() {
        ...
        if (user.getUse_version().equals("1")){
            list_title = new String[]{"接车","报价","完工","结算","结算金额","未结金额","实收金额"};
            list_res = new int[]{R.mipmap.boss_jieche,R.mipmap.boss_baojia,R.mipmap.boss_wangong,R.mipmap.boss_jieshuang,R.mipmap.boss_jieshuang_jingen,
                    R.mipmap.boss_weijie_jingen,R.mipmap.boss_shishou_jinen};
            list_class = new Class[]{PickUpCarDetailActivity.class
                    ,OfferDetailActivity.class,FinishDetailActivity.class,OutcarDetailActivity.class,SettledDetailActivity.class
                    ,UnsettledDetailActivity.class,ReceiptsDetailActivity.class};
        }
    }
    ...
    private void initTab() {
        ...
        mTabLayout.addTab(mTabLayout.newTab().setText("周"));
                ...
                //周是后面添加的，所以类型是5
                    switch (position){
                        case 0:
                            ...
                            break;
                        case 1:
                            dType = String.valueOf(5);
                            break;
                        case 2:
                            dType = String.valueOf(2);
                            break;
                        case 3:
                            dType = String.valueOf(3);
                            break;
                        case 4:
                            dType = String.valueOf(4);
                            break;
                    }
                getsumbytype();
            }
    ...
    private void getsumbytype(){
        ...
        HttpUtil.getInstance().postLoading(mContent, params, ORMBean.SumByTypeBean.class, new HttpUtil.HttpCallBack<ORMBean.SumByTypeBean>() {
            @Override
