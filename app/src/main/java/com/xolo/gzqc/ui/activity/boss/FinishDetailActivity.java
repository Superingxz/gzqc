...
public class FinishDetailActivity extends BaseActivity {
    ...
    private void initLv() {
        sumDetailCommenAdapter = new CommenAdapter<>(R.layout.item_info_1, mContext, list, new CommenAdapter.AdapterCallback() {
            ...
            public void setView(ViewHolder holder, int position) {
                ...
                holder.setText(R.id.item2,"维修班组名称："+sumDetail.getTeam_name());
                holder.setText(R.id.item3,"完工时间："+sumDetail.getAssign_time());
    ...
    private void  getfinishdetail(){
        RequestParams params = creatParams("getfinishdetail");
