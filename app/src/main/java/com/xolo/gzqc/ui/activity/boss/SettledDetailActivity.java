 ...
 * 结算金额明细
 */
public class SettledDetailActivity extends BaseActivity {
    ...
    private void initLv() {
        sumDetailCommenAdapter = new CommenAdapter<>(R.layout.item_info_1, mContext, list, new CommenAdapter.AdapterCallback() {
            ...
            public void setView(ViewHolder holder, int position) {
                ...
                holder.setText(R.id.item3,"结算金额："+sumDetail.getMoney_js());
    ...
    private void  getsettleddetail(){
        RequestParams params = creatParams("getsettleddetail");
