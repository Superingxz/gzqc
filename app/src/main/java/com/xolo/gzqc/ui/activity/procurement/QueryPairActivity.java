 ...
 * 历史报价
 */
public class QueryPairActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_query_pari);
    ...
    private void initLv() {
        adapter = new CommenAdapter<>(R.layout.item_info_1, mContext, list_part, new CommenAdapter.AdapterCallback() {
            ...
            public void setView(ViewHolder holder, int position) {
                ...
                holder.setText(R.id.item2, "时间：" + carInfo.getBuy_time());
    ...
    /**
     * 4-6 本维修厂的历史购件查询接口 getlisthistorybuyd(userid,dept_id,start_date,end_date,carno,brands,typecode,output_id,
     * productyear,parts_name)
     ...
     */
    private void getlisthistorybuyd() {
        RequestParams params = creatParams("getlisthistorybuyd");
