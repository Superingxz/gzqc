...
import com.xolo.gzqc.ui.fragment.ProcurementMainFragment;
 ...
 * 采购主页面
 */
public class ProcurementMainActivity extends BaseActivity {
    ...
    private void initMainViewPager() {
        fragments = new Fragment[]{new ProcurementMainFragment(), new PersonPickFragment()};
