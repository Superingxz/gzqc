 ...
 * 交车明细
 */
public class OutcarDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outcar_detail);
    ...
    private void initLv() {
        sumDetailCommenAdapter = new CommenAdapter<>(R.layout.item_info_1, mContext, list, new CommenAdapter.AdapterCallback() {
            ...
            public void setView(ViewHolder holder, int position) {
                ...
                holder.setText(R.id.item3,"交车时间："+sumDetail.getGive_date());
    ...
    private void  getoutcardetail(){
        RequestParams params = creatParams("getoutcardetail");
