        ...
        switch (v.getId()) {
            ...
            default:
                ...
                if (mMsg != null) {
                    ...
                    AppTool.getLocationCallback().onSuccess(mMsg);
//                    SealAppContext.getInstance().setLastLocationCallback(null);
                    finish();
                } else {
                    AppTool.getLocationCallback().onFailure("定位失败");
                }
                break;
        }
    }
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        if (i == 0) {
            if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null) {
                ...
                Log.i("LocationChange", shortAdd + latitude + "----" + longitude);
            } else {
                ToastUtil.showShort(AMAPLocationActivity.this, "没有搜索到结果");
            }
        } else {
            ToastUtil.showShort(AMAPLocationActivity.this, "搜索失败,请检查网络");
        }
    }
