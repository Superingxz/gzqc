 ...
 */
public class OfferExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public OfferExpandableAdapter(List<Offer> list_offer,  Context context) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.item3.setText("工时费   "+ offer.getWorkamt());
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_part_offer, parent, false);
        ...
        holder.item2.setText(repairlist.getSaleprice());
        holder.item3.setText("x "+repairlist.getQty()+" ( "+repairlist.getQty_unit()+" )");
        holder.item4.setText(repairlist.getSource());

        double total = Double.parseDouble(repairlist.getSaleprice()) * Integer.parseInt(repairlist.getQty());
        holder.item5.setText("￥"+String.valueOf(total));
